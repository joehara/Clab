  ...
  <table border="1">
	...
	while($record=mysql_fetch_array($result)) {
		...
		<tr> 
			...
			<td><a href=\"register_student2.php?id2=$record[student_id]\" onclick=\"return confirm(' ต้องการลบ $record[name] ออกจากระบบจริงหรือไม่ ')\"><img src=\"../images/b_usrdrop.png\"></a></td>
		</tr>";
	}
	mysql_close();
?>
